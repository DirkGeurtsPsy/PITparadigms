...
Tresh.bp    = 0.7;                 % percentage of maximum frequency from callibration should be reached to make a valid go.
...
% COM         = input('COM (0 if no pump): ');% Set up (comport of) pump
COM         = 0;
home        = pwd;
...
pump.tubeLength    = 0          %input('Tubelength? (10=if patient is in scanner; 1000=to run it through)');     % in cm
...
dummyStart  = 30; %How many scantriggers should be collected for PAIDweightalgorithm
dummyStop   = 6;  %How many scantriggers after last trial (to capture last BOLD) 
fmri        = 0;         %input('Do you want to use the fmri scanner? 1=yes 0=no');
Trigger     ='5%';  %Input for trigger
Triggernr   = 53;   %Input for trigger



%--------------------------------------------------------------------------
%
%BITSI settings (device that sends triggers to eyetracker etc.)
%
%--------------------------------------------------------------------------

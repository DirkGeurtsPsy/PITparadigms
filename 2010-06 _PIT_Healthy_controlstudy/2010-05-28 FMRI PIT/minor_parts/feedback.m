...
if start==1
        payout1 =(sum(O(13,1:Tr.Tot1))*0.05) + (sum(O(13,Tr.Tot2+1:Tr.Tot3))*0.05);
elseif start==0
        payout1 =(sum(O2(13,1:Tr.Tot1))*0.05) + (sum(O2(13,Tr.Tot2+1:Tr.Tot3))*0.05);
end
...
if start==1
        payout2 =(sum(O(13,1:Tr.Tot1))*0.05) + (sum(O(13,Tr.Tot2+1:Tr.Tot3))*0.05) + payout1;
elseif start==0
        payout2 =(sum(O2(13,1:Tr.Tot1))*0.05) + (sum(O2(13,Tr.Tot2+1:Tr.Tot3))*0.05) + payout1;
end

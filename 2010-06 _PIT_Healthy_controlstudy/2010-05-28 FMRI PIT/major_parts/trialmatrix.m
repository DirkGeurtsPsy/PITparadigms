...
% row1= trialnumber
% row2= Approach/withdrawal for instrumental and PIT trials
% row3= which stimulus to present for Inst/Pav/PIT
% row4= value of stimulus
% row5= outcome go
% row6= outcome nogo
% row7= outcome pav
% row8= on which side to present the BWall.
% row9= reaction time
% row10= response frequency
% row11= choice
% row12= correct/incorrect
% row13= reward
% row14= number of presses
% row15= time first keypress
% row16= time last keypress
% row17= time stim pres
% row18= time till end trial
% row19= time feedback switched on
% row20= time feedback switched off
% row21= time ON trial
% row22= time OFF trial
% row23= pavlovian stimulus on PIT trials
% row24= value of pavlovian stimulus
...
X=O(2,(O(2,1:Tr.TotInst)==1)&(O(4,1:Tr.TotInst)>0));
X((1:(1-St.Inst.F)*length(X)))=-1;
X=mix(X);
O(5,(O(2,1:Tr.TotInst)==1)&(O(4,1:Tr.TotInst)>0))=X;
...
X=(O(2,(O(2,1:Tr.TotInst)==2)&(O(4,1:Tr.TotInst)>0)))/2;
X(1:(St.Inst.F*length(X)))=-1;
X=mix(X);
O(5,(O(2,1:Tr.TotInst)==2)&(O(4,1:Tr.TotInst)>0))=X;
...
X=O(2,(Tr.Tot2)+find((O(2,(Tr.Tot2+1):Tr.Tot3)==1)&(O(4,(Tr.Tot2+1):Tr.Tot3)>0)));
X((1:(1-St.Inst.F)*length(X)))=-1;
X=mix(X);
O(5,(Tr.Tot2)+find((O(2,(Tr.Tot2+1):Tr.Tot3)==1)&(O(4,(Tr.Tot2+1):Tr.Tot3)>0)))=X;
...
X=(O(2,(Tr.Tot2)+find((O(2,(Tr.Tot2+1):Tr.Tot3)==2)&(O(4,(Tr.Tot2+1):Tr.Tot3)>0))))/2;
X(1:(St.Inst.F*length(X)))=-1;
X=mix(X);
O(5,(Tr.Tot2)+find((O(2,(Tr.Tot2+1):Tr.Tot3)==2)&(O(4,(Tr.Tot2+1):Tr.Tot3)>0)))=X;
...
%%
%% make trialmatrices
% O2utcome matrix for whole experiment:
% row1= trialnumber
% row2= Approach/withdrawal for instrumental and PIT trials
% row3= which stimulus to present for Inst/Pav/PIT
% row4= value of stimulus
...
% row19= time feedback switched on
% row20= time feedback switched off
% row21= time O2N trial
% row22= time O2FF trial
% row23= pavlovian stimulus on PIT trials
% row24= value of pavlovian stimulus
% row25= adjusted choice (<3 buttonpresses is regarded as nogo)
% row26= adjusted correct/incorrect
...
% matrix for pavlovian comparisontrials
% row1=comparisontrial number
% row2=stimulus1
% row3=stimulus2
% row4=choice
% Co=NaN(4,(Tr.TotPav/Comp));
% Co(1,:)=1:(Tr.TotPav/Comp);
...
%% O2utcome for Go
% outcome for Go in approach trials with positive inst stimulus in instrumental training.
X=O2(2,(O2(2,1:Tr.TotInst)==1)&(O2(4,1:Tr.TotInst)>0));
X((1:(1-St.Inst.F)*length(X)))=-1;
X=mix(X);
O2(5,(O2(2,1:Tr.TotInst)==1)&(O2(4,1:Tr.TotInst)>0))=X;
% outcome for Go in approach trials with negative inst stimulus in instrumental training.
X=O2(2,(O2(2,1:Tr.TotInst)==1)&(O2(4,1:Tr.TotInst)<0));
X(1:(St.Inst.F*length(X)))=-1;
X=mix(X);
O2(5,(O2(2,1:Tr.TotInst)==1)&(O2(4,1:Tr.TotInst)<0))=X;
% outcome for Go in withdrawal trials with positive inst stimulus in instrumental training.
X=(O2(2,(O2(2,1:Tr.TotInst)==2)&(O2(4,1:Tr.TotInst)>0)))/2;
X(1:(St.Inst.F*length(X)))=-1;
X=mix(X);
O2(5,(O2(2,1:Tr.TotInst)==2)&(O2(4,1:Tr.TotInst)>0))=X;
% outcome for Go in withdrawal trials with negative inst stimulus in instrumental training.
X=(O2(2,(O2(2,1:Tr.TotInst)==2)&(O2(4,1:Tr.TotInst)<0)))/2;
X(1:((1-St.Inst.F)*length(X)))=-1;
X=mix(X);
...
% outcome for Go in approach trials with positive inst stimulus in PIT.
X=O2(2,(Tr.Tot2)+find((O2(2,(Tr.Tot2+1):Tr.Tot3)==1)&(O2(4,(Tr.Tot2+1):Tr.Tot3)>0)));
X((1:(1-St.Inst.F)*length(X)))=-1;
X=mix(X);
O2(5,(Tr.Tot2)+find((O2(2,(Tr.Tot2+1):Tr.Tot3)==1)&(O2(4,(Tr.Tot2+1):Tr.Tot3)>0)))=X;
% outcome for Go in approach trials with negative inst stimulus in PIT.
X=O2(2,(Tr.Tot2)+find((O2(2,(Tr.Tot2+1):Tr.Tot3)==1)&(O2(4,(Tr.Tot2+1):Tr.Tot3)<0)));
X(1:(St.Inst.F*length(X)))=-1;
X=mix(X);
O2(5,(Tr.Tot2)+find((O2(2,(Tr.Tot2+1):Tr.Tot3)==1)&(O2(4,(Tr.Tot2+1):Tr.Tot3)<0)))=X;
% outcome for Go in withdrawal trials with positive inst stimulus in PIT.
X=(O2(2,(Tr.Tot2)+find((O2(2,(Tr.Tot2+1):Tr.Tot3)==2)&(O2(4,(Tr.Tot2+1):Tr.Tot3)>0))))/2;
X(1:(St.Inst.F*length(X)))=-1;
X=mix(X);
O2(5,(Tr.Tot2)+find((O2(2,(Tr.Tot2+1):Tr.Tot3)==2)&(O2(4,(Tr.Tot2+1):Tr.Tot3)>0)))=X;
% outcome for Go in withdrawal trials with negative inst stimulus in PIT.
X=(O2(2,(Tr.Tot2)+find((O2(2,(Tr.Tot2+1):Tr.Tot3)==2)&(O2(4,(Tr.Tot2+1):Tr.Tot3)<0))))/2;
X(1:((1-St.Inst.F)*length(X)))=-1;
X=mix(X);
